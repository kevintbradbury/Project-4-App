...
//                TempoDateFormatter.sharedInstance.dateFormatter.timeZone = self.timeZone as TimeZone!
//                self.updateDate()
...
//            if (self.locale != nil) {
//                TempoDateFormatter.sharedInstance.dateFormatter.locale = self.locale as Locale!
//                self.updateDate()
//                self.updateComponents()
//            }
//        }
...
//    }
//
//    typealias DateFormatBuilder = (_ newTemp:Tempo) -> ()
//    
...
//        
//        var dateComponents = TempoDateFormatter.sharedInstance.calendar!.components(NSCalendar.Unit.weekdayOrdinal, from: NSDate() as Date)
//        
...
//        self.date = TempoDateFormatter.sharedInstance.calendar?.date(from: dateComponents) as NSDate!
//    }
//    
//    func updateComponents() {
//        var dateComponents = TempoDateFormatter.sharedInstance.calendar!.components(NSCalendar.Unit.CalendarUnitYear |
//            NSCalendar.Unit.month | NSCalendar.Unit.day |
//            NSCalendar.Unit.hour | NSCalendar.Unit.minute |
//            NSCalendar.Unit.second, fromDate: self._date)
//        
...
//        
//    init() {
//        self._locale = NSLocale.autoupdatingCurrent as NSLocale!
//        self._date = NSDate()
//        self.updateComponents()
//    }
//    
//    convenience init(stringDate: String, timeLocale: NSLocale = NSLocale.autoupdatingCurrent,
...
//            if let date = TempoDateFormatter.sharedInstance.dateFormatter.date(from: stringDate) {
//
//                var dateComponents = TempoDateFormatter.sharedInstance.calendar!.components(NSCalendar.Unit.CalendarUnitYear |
//                    NSCalendar.Unit.CalendarUnitMonth | NSCalendarUnit.CalendarUnitDay |
...
//        timeLocale: NSLocale = NSLocale.autoupdatingCurrent,
...
//                    NSCalendar.Unit.month | NSCalendar.Unit.day |
//                    NSCalendar.Unit.hour | NSCalendar.Unit.minute |
//                    NSCalendar.Unit.second , fromDate: date)
//                
//                self._years = dateComponents.year
//                self._months = dateComponents.month
//                self._days = dateComponents.day
...
//            
//            let dateString = TempoDateFormatter.sharedInstance.dateFormatter.string(from: _date as Date)
//            let dateConvert = TempoDateFormatter.sharedInstance.dateFormatter.date(from: dateString)
//            if (dateConvert != nil) {
//                return dateString
//            }
//        }
...
//        if isSame(tempo: tempoLeft) || isSame(tempo: tempoRight) {
//            return false
//        }
...
//        return (self.diffDay(tempo: tempo) == 0 ? true : false)
//    }
//
//    /**
...
//        return (self.diffMonth(tempo: tempo) == 0 ? true : false)
//    }
//    
//    /**
...
//        return (self.diffYear(tempo: tempo) == 0 ? true : false)
//    }
//    
//    /**
...
//            }
//        }
//        else if self.isThisMonth(tempo: now) {
//            if self.days == now.days - 1 {
//                return "Yesterday"
//            }
//            let diffWeek = self.diffWeek(tempo: now)
//            if diffWeek == 0 {
//                return "This week"
//            }
//            else if diffWeek == 1 {
...
//            }
//        }
//        else if self.isThisYear(tempo: now) {
//            let diffMonth = self.diffMonth(tempo: now)
...
//            }
//        }
//        let diffYear = self.diffYear(tempo: now)
//        if diffYear == 0 {
//            return "This year"
//        }
//        else if diffYear == 1 {
...
//        return self.timeAgoSimple(tempo: nil)
//    }
//
//    /**
...
//        return self.timeAgoSimple(tempo: tempo)
//    }
//
//    /**
...
//        return self.timeAgo(tempo: tempo)
//    }
//    
//    /**
...
//        return self.dateTimeUntil(tempo: nil)
//    }
//
//    /**
...
//        return self.dateTimeUntil(tempo: tempo)
//    }
//}
//
